 ...
 */
class Worldview_Feed_Helper_Retrieval_Rss
    extends Worldview_Feed_Helper_Retrieval_Abstract
    implements Worldview_Feed_Helper_Retrieval_Interface
{
    ...
    {
        $feedSourceCollection = Mage::getModel('worldview_source/source')
                                    ->getCollection()
